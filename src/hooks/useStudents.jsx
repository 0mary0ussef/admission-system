...
export const useStudents = () => {
  ...
  const fetchStudents = async () => {
    try {
      ...
      setCurrentPage(1);
      setPageSize(studentsData.length);
      setTotalPages(1);
  ...
  // Fetch students for a specific page (no longer needed since we removed pagination)
  const fetchStudentsForPage = (page) => {
    setCurrentPage(page);
    fetchStudents();
  };

  // Change page size (no longer needed since we removed pagination)
