...
const RegisterStudentPage = () => {
  ...
  const validateForm = () => {
    ...
    if (isNaN(englishScore) || englishScore < 0 || englishScore > 40) {
      errors.push("English score must be between 0 and 40");
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Force re-render of form inputs to clear validation states
              ...
              <form key={formKey} onSubmit={handleSubmit} className="space-y-6">
                      ...
                      onChange={(e) => {
                        ...
                        if (
                          ...
                          if (!isNaN(numValue) && numValue > 40) {
                            handleInputChange("englishScore", "40");
                          } else {
                      ...
                      onChange={(e) => {
                        ...
                        if (
                          ...
                          if (!isNaN(numValue) && numValue > 280) {
                            handleInputChange("finalYearScore", "280");
                          } else {
                ...
                <div className="mb-6">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      key={`isAcceptanceLetterReceived-${formKey}`}
                ...
                {isAcceptanceLetterReceived && (
                  <div>
                      ...
                      onChange={(e) => {
                        ...
                        if (
                          ...
                          if (!isNaN(numValue) && numValue > 100) {
                            handleInputChange("ministryExamPercentage", "100");
                          } else {
                    ...
                    />
                    <p className="text-sm text-gray-500 mt-1">
                      النطاق المسموح: 0.00 إلى 100.00
                    </p>
                  </div>
                )}
