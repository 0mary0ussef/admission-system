                ...
                <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-900 font-medium">
                        {studentInfo.admissionProfile?.mathScore || "غير محدد"}
                      </p>
                    </div>
                    <div>
                      <Label className="text-sm font-medium text-blue-700">
                      ...
                      <p className="text-blue-900 font-medium">
                        {studentInfo.admissionProfile?.englishScore ||
                          "غير محدد"}
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="text-blue-900 font-medium">
                        {studentInfo.admissionProfile?.thirdPrepScore ||
                          "غير محدد"}
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="text-blue-900 font-medium">
                        {studentInfo.admissionProfile?.ministryExamPercentage ||
                          "غير محدد"}
                        %
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="text-blue-900 font-medium">
                        {studentInfo.admissionProfile?.dateOfBirth
                          ? new Date(
                              studentInfo.admissionProfile.dateOfBirth
