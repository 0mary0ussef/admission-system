            ...
            <div className="relative">
              ...
              {searchTerm !== debouncedSearchTerm && (
                <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
                  <div className="animate-pulse text-xs text-blue-600 bg-blue-100 px-2 py-1 rounded">
                    Searching...
                  </div>
                </div>
              )}
                    ...
                    <TableBody>
                      ...
                      {students.map((student) => (
                        <TableRow key={student.id}>
                          ...
                          {/* Contact Student Data, display Contact Student in a table, twelfth column*/}
                          <TableCell>
                            <Button
                              size="sm"
                              variant="outline"
