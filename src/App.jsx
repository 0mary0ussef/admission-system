...
function App() {
  ...
  useEffect(() => {
    ...
    // Don't clear exam-related data on app start - let students take exams
    ...
    // Keep student data for better UX (Phase 2 requirement)
    // localStorage.removeItem("studentNationalId");
      ...
      <Router>
        ...
        <div className="App">
          <Routes>
            ...
            />
            <Route path="/staff-admin/search" element={<StaffAdminSearchPage />} />
