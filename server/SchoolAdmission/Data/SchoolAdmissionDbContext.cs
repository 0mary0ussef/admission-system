...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=(localdb)\\ProjectModels;Initial Catalog=ElsewedySchoolSys;Integrated Security=True;TrustServerCertificate=true;Encrypt=false");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Account>(entity =>
        {
            ...
            entity.HasIndex(e => e.Email, "UQ__Account__A9D10534AD3ADB27").IsUnique();

            entity.HasIndex(e => e.NationalId, "UQ__Account__E9AA32FA7627D682").IsUnique();
        ...
        modelBuilder.Entity<AccountType>(entity =>
        {
            ...
            entity.HasIndex(e => e.AccountTypeName, "UQ__AccountT__602E1DF2733DAE58").IsUnique();
