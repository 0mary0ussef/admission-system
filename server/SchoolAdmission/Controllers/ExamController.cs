...
public class ExamController : ControllerBase
{
    ...
    private async Task CalculateAndUpdateResults(long accountId)
    {
        ...
        {
            Console.WriteLine($"Section {section.Key}: {section.Value.CorrectAnswers}/{section.Value.TotalQuestions} correct = {section.Value.ScoreOutOf15} out of 15");
        }
        ...
        var mathScore = scoresBySection.GetValueOrDefault("Math", new { CorrectAnswers = 0, TotalQuestions = 0, Percentage = 0.0, ScoreOutOf15 = 0.0 }).ScoreOutOf15;
        var mathARScore = scoresBySection.GetValueOrDefault("MathAR", new { CorrectAnswers = 0, TotalQuestions = 0, Percentage = 0.0, ScoreOutOf15 = 0.0 }).ScoreOutOf15;
    ...
    public async Task<IActionResult> RequestTimeExtension([FromBody] TimeExtensionDTO dto)
    {
        ...
        if (teacher == null || teacher.AccountType?.AccountTypeName != "Teacher")
