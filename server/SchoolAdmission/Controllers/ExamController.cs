...
public class ExamController : ControllerBase
{
    ...
    private async Task CalculateAndUpdateResults(long accountId)
    {
        ...
        Console.WriteLine($"Final scores - Arabic: {results.ExamArabicScore}, English: {results.ExamEnglishScore}, Math: {results.ExamMathScore}, Software: {results.ExamSoftwareScore}");
    }
