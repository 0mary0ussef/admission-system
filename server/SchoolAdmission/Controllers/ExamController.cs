...
public class ExamController : ControllerBase
{
    ...
    */
    ...
    public async Task<IActionResult> GetQuestionsBySectionWithSchoolType(string sectionName, string nationalId)
    {
        ...
        // Log the section mapping for debugging
        Console.WriteLine($"Student {student.NationalId} - School Type: {student.AdmissionProfile?.PreviousSchoolType}");
        Console.WriteLine($"Requested Section: {sectionName} -> Actual Section: {actualSectionName}");
